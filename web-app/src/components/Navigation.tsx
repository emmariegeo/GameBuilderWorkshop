import { Box, CssBaseline, AppBar, Toolbar, IconButton, Typography, Button, Divider, ListItemButton, ListItem, List, ListItemText, Dialog, DialogTitle, DialogContent, DialogActions, Drawer } from '@mui/material';
            ...
            <AppBar component="nav">
                <Toolbar>
                    ...
                    <Box sx={{ display: 'block' }}>
                        {navItems.map((item) => (
                            <Button key={item} sx={{ color: '#fff' }} onClick={handleClickOpen}>
                                {item}
                            </Button>
                        ))}
                    </Box>
